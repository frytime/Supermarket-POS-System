...
{
    public partial class EmployeeTill : Form
    {
        ...
        private void btnPrint_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (txtCash.Text != "" && txtCustomerName.Text != "" && double.Parse(txtCash.Text) >= double.Parse(txtTotal.Text) && txtChange.Text != "" && txtTotal.Text != "" && txtSubTotal.Text != "" && txtTax.Text != "" && dataGridView_basket != null)
                {
                    ...
                    TextWriter Printer = new StreamWriter("Reciept-'" + recieptnum.ToString() + "'.txt");
                    Printer.WriteLine("Date and Time: " + DateTime.Now);
                    Printer.WriteLine("Reciept Number: " + recieptnum.ToString());
                    Printer.WriteLine("");
                    ...
                    Process.Start("notepad.exe", @"Reciept-'" + recieptnum.ToString() + "'.txt");
                }
